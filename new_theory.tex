...
test performed.  
\todo[inline]{Expand on this point. Give an example of an accurate prediction.}
...
centuary ago\cite{maxwell}\todo{cite maxwell}, and a quantum theory of electrodynamics was
realised by Tomonaga, Feynman and Schwinger in the 1940s \cite{qed}\todo{cite
feynman}.
...
The fundemental process of Quantum Electrodynamics (QED) is shown in \FigureRef{fig:qed}.
\begin{figure}[htbp]
  \centering
...
only appear in bound states. This phenomenon is known as quark confinement.  \todo{diagram
of quark confinement here?}
