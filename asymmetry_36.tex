...
In the analysis, a control region is obtained by inverting the $\Delta\phi$ and
...
\unit{25}{\GeV}. The analysis shown presents the results with \pT cuts of 25, 30
and \unit{35}{\GeV}.
...
shown in \FigureRef{asym36:pfmet}.  The number of selected events that pass the
event selection are shown in \TableRef{asym36:selectedevents}.
...
& &               &               &                &  $\ETm>20$ \GeV \\ 
\midrule
Signal & \HepProcess{\PW\to\Pe\Pnu} & $65.1\%$&$63.5\%$ &$60.2\%$  &$95.3\%$\\
EWK & \HepProcess{\PZ\to\Ptau\Ptau} & $0.4\%$ &$0.3\%$  &$0.2\%$   &$0.2\%$ \\
    & \HepProcess{\PZ\to\Pe\Pe}     & $4.1\%$ &$3.5\%$  &$3.0\%$   &$0.3\%$ \\
    & \HepProcess{\PW\to\Ptau\Pnu}  & $1.9\%$ &$1.1\%$  &$0.6\%$   &$2.3\%$ \\
    & \HepProcess{\Ptop\APtop}      & $0.3\%$ &$0.3\%$  &$0.3\%$   &$0.4\%$ \\
    & Total                         & $6.7\%$ &$5.2\%$  &$4.1\%$   &$3.2\%$ \\
QCD & Total                         & $28.2\%$&$31.3\%$ &$35.7\%$  &$1.5\%$\\
    \bottomrule
\end{tabular}
...
\multicolumn{4}{c}{$\sigma(\mathcal{A})_{misch}\times 10^{-4}$} ($\pT>,\ETmiss>$)\\
& & (25,0) & (30,0) & (35,0) & (25,20) \\
\midrule
