...
subdetectors of {CMS}.  This chapter describes how the information
...
direction, so that when the electron reaches the s{ECAL} it is accompanied
...
is measured when using the electron trajectory from the {GSF} fit.  A sample with
