...
with a \APdown sea-quark (\EquationRef{wbos:wpprod}). If the parton masses are
neglected the \Pup is left-handed and the \APdown is right-handed, as shown at
the top of \FigureRef{wbos:wspin}. In the \PWp decay the a right-handed
...
\EquationRef{wbos:lepton} with the \PW repidity described in
\SectionRef{wbos:wrapsec}:
