...
\todo{include a discusion on factorisation here}
\begin{multline}
...
momentum of the colliding hadron $h$.  
\todo[inline]{define Q2}
...
\unit{10^{4}}{\GeV^2} $ (right) from \cite{martin2009parton}.}
  \label{wbos:pdf}
\end{figure}
...
\todo{rewrite this to be correct}
...
$Q^2=\unit{100}{\GeV^2}$.  Generated from \cite{hepdata} using the MSTW2008nlo
...
\todo[inline]{introduce FSR/radiative corrections here?}
