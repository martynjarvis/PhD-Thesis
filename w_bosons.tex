...
%\subsection*{Electroweak blah }
The \PW boson is a spin-1 particle, and therefore the production and the decay
are correlated due to the $V-A$ coupling of the \PW boson to the annihilating
\HepProcess{\Pquark\APquark} pair and the decaying lepton pair.


The angular distribution of the charged lepton is given by 
...
The cross section is therefore maximised when $\theta_{\Plepton D}^{\ast}$ is
zero, where the outgoing lepton moves in the same direction as the colliding
down-type quark.

In proton-proton collisions the \PWp is produced by the process in
\EquationRef{wbos:wpprod}. The up-type quark tends to carry a greater fraction
fo the momentum, and therefore the \PWp tends to be produced in the direction
...
\PWm (\EquationRef{wbos:wmprod}) tend to be produced more centrally, however
