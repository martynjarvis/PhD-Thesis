...
selection\cite{baisini2010electron}.\todo{PT cut?}}\label{fig:zpeak} 
\end{figure}
...
\todo{state what I should take from this}
...
The \ETm distributions for the {electroweak} background were obtained from Pythia MC
...
\todo[inline]{work out what to do with this...}
...
assigned in each bin is $0.070$.  \todo{uh oh!}
...
sample by $\pm10\%$.\todo{explain that?} The effect that this has on the asymmetry is taken
