...
\unit{25}{\GeV} it is expected that the $65\%$ of selected events are 
...
To validate the anti-selection used, {QCD} Monte Carlo simulation (MC) samples are used. The
...
The $\chi^2$ of each fit is noted in \TableRef{tab:chi2}.
...
combinations of pseudorapidity bins of the two electrons.  A mass template s
...
and the asymmetry measured with the chosen anti-selection in MC pseudo data and real data for each eta bin\cite{baisini2010electron}.}
\label{tab:systQCD}
\end{center}
\end{table}
