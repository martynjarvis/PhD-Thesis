...
\TableRef{tab:lhcparam} sumarises the machine parameters relevent to the
\ac{CMS} detectors.
...
The \ac{ECAL} energy resolution is shown in \FigureRef{fig:ECAL}.  The
...
The \ac{HCAL} is a brass/scintillator
...
The layout of the \acs{CMS} muon system is shown in \FigureRef{fig:muon_system}.
