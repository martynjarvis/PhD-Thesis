...
The main motivation for the LHC is to determine the mechanism by which electroweak
symmetry is broken. 
...
micro-strip detectors where the particle flux is reduced.
...
detected by photodetectors. The calorimeter needs to be radiation hard as in the
...
second.
A zero suppressed event output from CMS is about \unit{2}{MB} so the total data
